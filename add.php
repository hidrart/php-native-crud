<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!empty($first_name) && !empty($last_name) && !empty($email) && !empty($gender)) {
            $query = "INSERT INTO mahasiswa (first_name, last_name, email, gender) VALUES ('$first_name', '$last_name', '$email', '$gender')";
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link fw-bold" href="add.php">Add Data</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class="p-5">
        <div class="container">
            <div class="row row-cols-1 row-cols-lg-2 align-items-center">
                <img src="assets/img/Graduation-bro.svg" class="col order-lg-1 rounded w-lg-50 float-end" alt="Food Illustration">
                <div class="col order-lg-2 d-flex flex-column align-middle gap-3 mb-3">
                    <div class="row text-center text-lg-start">
                        <h1 class="title fw-bold">Add data mahasiswa</h1>
